...
const Accordion = AccordionPrimitive.Root as React.ComponentType<
  React.ComponentPropsWithoutRef<typeof AccordionPrimitive.Root> & { className?: string; children?: React.ReactNode }
>

const AccordionItem = React.forwardRef<
  React.ElementRef<typeof AccordionPrimitive.Item>,
  React.ComponentPropsWithoutRef<typeof AccordionPrimitive.Item> & { className?: string; children?: React.ReactNode }
>(({ className, ...props }, ref) => (
